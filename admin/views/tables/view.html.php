...
/**
 * Tables list view class.
 *
 * @package     Datagrill
 * @subpackage  Views
 */
class DatagrillViewTables extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		DatagrillHelper::addSubmenu('tables');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_DATAGRILL_DATAGRILLTABLE_VIEW_TABLES_TITLE'));
		
		if ($canDo->get('core.create'))
		{
			JToolBarHelper::addNew('your_database_table.add','JTOOLBAR_NEW');
		}

		if (($canDo->get('core.edit')) && isset($this->items[0]))
		{
			JToolBarHelper::editList('your_database_table.edit','JTOOLBAR_EDIT');
		}
