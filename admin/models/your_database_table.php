...
class JFormFieldYour_database_application extends JFormFieldList
{
	/**
	 * The form field type.
	 *
	 ...
	 * @since  11.1
	 */
	protected $type = 'your_database_application';
...
class DatagrillModelYour_Database_Table extends JModelAdmin
{
	/**
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_datagrill.your_database_table';
	 ...
	 */
	public function getTable($type = 'Your_Database_Table', $prefix = 'DatagrillTable', $config = array())
	{
